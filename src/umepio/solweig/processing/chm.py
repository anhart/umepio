...
class CHM:
    ...
    '''
    def __init__(self, bbox, dtm, dsm, trunk_height, output_folder_chm, output_folder_las='temp', resolution=0.5, merged_output='pointcloud.las', ndvi_threshold=0.05):
        '''
    ...
    def read_lookup(self):
        ...
        '''
        try:
            resource = files("umepio").joinpath("geotiles/AHN_lookup.geojson")
    ...
    def init_chm(self, bbox, output_folder, input_folder, merged_output="pointcloud.las",  smooth_chm=True, resolution=0.5, ndvi_threshold=0.05, filter_size=3):
        '''
        ...
        if las_data is None:
            ...
            return None, None, None
        # las_data.write(f"{output_folder}/pointcloud.las")
