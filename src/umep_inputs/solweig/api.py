...
from umep_inputs.solweig.processing.buildings import Buildings
from umep_inputs.solweig.io_utils import plot_geojson, show_raster_array, visualize_landcover_raster, write_output_landcover
...
def load_landcover(bbox, output_folder, plot=False, crs="http://www.opengis.net/def/crs/EPSG/0/28992", use_bgt=True, main_roadtype=0, resolution=0.5, building_data=None, dataset=None,
                 dataset_path=None, buildings_path=None, layer=None, nodata_fill=0, roads_on_top=True, landcover_path_bgt="src/umep_inputs/databases/landcover_bgt.json",  landcover_top="src/umep_inputs/databases/landcover_top.json"):
    """
...
def generate_solweig_inputs(
    ...
    *,
    ...
    nodata_fill=0,
    roads_on_top=True,
    landcover_path_bgt="src/umep_inputs/databases/landcover_bgt.json",
    landcover_top="src/umep_inputs/databases/landcover_top.json",
):
    """
